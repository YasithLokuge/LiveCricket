...
Run the following Maven command. This will create the fat jar LiveCricket-1.0.jar in the target directory.
...
```
java -jar target/LiveCricket-1.0.jar server deploy/config.yml
```
